<template>
  <div class="movie-detail">
    ...
    <div class="detail">
      <div class="poster">
        <router-link tag="div" class="movie-preview"
        v-if="show"
      ...
      <div class="content">
        ...
        <div class="score ellipsis p1">
          <span :class="{stars:show}">
            <img v-if="show" v-for="(star, key) in stars" :key="key" :src="star" alt="">
      ...
      <router-link v-if="!show" :to="'/movie/'+ detailMovie.id" class="iconfont icon-arrow-right"/>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    stars () {
      ...
      const end = sc - this.detailMovie.sc > .5 ? 1: 0
      const start = 10 - sc
